...
Config.Door1 = 'vange-vange' -- name of the door in your doorlock config
...
Config.WhitelistedWeapons = {
    ...
    -- This is for the UK Side of the robbery as some of you may use this for a uk Server so ima make it easy for you instead of yous putting the knifes and shit here i will :)
    [`weapon_knife`] = {
        ["timeOut"] = 10000
    },
    [`weapon_dagger`] = {
